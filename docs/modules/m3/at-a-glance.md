...
discussed in the videos and with skills required for the assignments. You are
...
- Recognize the different levels of abstraction implied in the terms collection, data structure, and container data type.
- Recognize common types of collections.
- Identify the role of interfaces and classes when creating collections in Python.
...
- Create linear linked structures in Python.
