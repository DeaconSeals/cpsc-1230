...
# CPSC 1230 Data Structures <br> Summer 2026 Course Syllabus
...
No specific text is required for this course, but it may be useful to select
a good text for reference and studying. There are many excellent texts on data
structures and algorithms, and I've listed two examples below. Miller and Ranum
is available for as a free e-text, while Goodrich et al. is available for
purchase from Amazon and other booksellers. For full disclosure, this course is
not designed to specifically follow either of these textbooks.

> **Miller**, Brad and **Ranum**, David (2006). *Problem Solving with 
...
>
> **Goodrich**, Michael T., **Tamassia**, Roberto , and **Goldwasser** Michael H.
> (2013). *Data Structures and Algorithms in Python, 1st Edition*, Wiley.
...
This course will require the use of Python and other software. This software
is free, and instructions on installation and use will be provided in Canvas
...
Auburn, AL 36849 
`szt0086@auburn.edu`
**Office Hours:** MW 4:30pm-5:30pm via Zoom [https://auburn.zoom.us/j/5326143552](https://auburn.zoom.us/j/5326143552) -->
...
- **Assignments** (30%): There will be several assignments designed to both
  ...
  Python.  Most assignments will be completed individually while some may be
...
----  | -----          | ------ | ------------
1     | Mon 18 May - Sun 24 May | M0     | H     
2     | Wed 25 May - Sun 31 May | M1     | H
3     | Mon 01 Jun - Sun 07 Jun | M2     | H A E T
4     | Mon 08 Jun - Sun 14 Jun | M3     | H
5     | Mon 15 Jun - Sun 21 Jun | M4     | H A E T 
6     | Mon 22 Jun - Sun 28 Jun | M5     | H
7     | Mon 29 Jun - Sun 05 Jul | M6     | H
8     | Mon 06 Jul - Wed 08 Jul | M7     | H A E T
